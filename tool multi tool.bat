...
set /p free=free:
set /p free=free:
if %free% == free if %free% == free goto main
...
echo [9] - pincracker
echo [10] - ip33
echo [11] - ip booter WORKING {BEST ONE}
echo [12] - headless account generator working
echo [13] - roblox account with korblox generator
echo [14]  - DA HOD UNBAN OPEN ME!
echo [15]  - tokens join a server
echo [16]  - discord members join ur server
echo [17]  - gift card generator
set /p main=Option: 
if %main% == 1 goto o1
echo.
if %main% == 2 goto o2
...
if %main% == 7 goto lol
if %main% == 8 goto lmao
if %main% == 9 goto pincracker
if %main% == 10 goto ip33
if %main% == 11 goto best
if %main% == 12 goto lick
if %main% == 13 goto lick
if %main% == 14 goto lick
if %main% == 15 goto yo
if %main% == 16 goto yo
if %main% == 17 goto yo
:o1
...
goto main
:best
start https://stresslab.sx/u/panel
goto main
:lick
start headless
goto main
